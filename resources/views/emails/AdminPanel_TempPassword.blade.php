...
<head>
	...
	<title>A&amp;S KITCHEN | Temporary Password</title>
				...
				<table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
					<tbody><tr>
						...
						<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
							...
							<p><span style="font-size:15px"><span style="font-family:lato,helvetica neue,helvetica,arial,sans-serif">Enter this temporary password&nbsp;into your A&amp;S KITCHEN Admin Panel to set a new password.<br>
								<br>
